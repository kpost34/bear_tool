...
# 2. GATE 1: Did we get past structural validation and calculate stats? 
pass_audit <- !is.null(my_suitcase$stats)


# 3. GATE 2: Did the modeling pipeline run?
pass_modeling <- !is.null(my_suitcase$modeling$winner_name)


# 4. Define Audit Variables (Only if Gate 1 passed)
if(pass_audit) {
...
# 5. Define Modeling Variables (Only if Gate 2 passed)
if(pass_modeling) {
...
::: {.content-visible when-is-expr="pass_audit"}
...
::: {.content-visible when-is-expr="pass_modeling"}
